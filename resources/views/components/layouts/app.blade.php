...
<body>
    <aside class="sidebar">
        ...
        <div>
            <a href="{{ route('home') }}" class="sidebar-logo">
                <h6 class="text-center">TO-DO APP</h6>
            </a>
        </div>
    ...
    <main class="dashboard-main">
                                ...
                                <div class="max-h-400-px overflow-y-auto scroll-sm pe-4">
                                    <a href="javascript:void(0)"
                                        ...
                                        <div
                                            ...
                                            <div>
                                                <h6 class="text-md fw-semibold mb-4">Reminder</h6>
                                                <p class="mb-0 text-sm text-secondary-light text-w-200-px">Your task for {{ \Carbon\Carbon::now()->format('d, D M Y') }} is almost due</p>
                                            </div>
                                        </div>
                            ...
                            <div class="dropdown-menu to-top dropdown-menu-sm">
                                <div
                                    ...
                                    <div>
                                        ...
                                        <span class="text-secondary-light fw-medium text-sm">{{ Auth::user()->is_admin ? 'Admin' : 'User' }}</span>
                                    </div>
        ...
        <footer class="d-footer">
            <div class="row align-items-center justify-content-between">
                <div class="col-auto">
                    <p class="mb-0">© 2024 NIEL. All Rights Reserved.</p>
                </div>
                <div class="col-auto">
                    <p class="mb-0">Made by <span class="text-primary-600">NIEL</span></p>
                </div>
            </div>
        </footer>
    </main>
